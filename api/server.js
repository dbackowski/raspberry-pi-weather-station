...
app.get('/api/forecast', async (req, res) => {
  const geoApiUri = `https://maps.googleapis.com/maps/api/geocode/json?address=${encodeURIComponent(escape(dotEnvConfig.parsed['CITY']))}&key=${dotEnvConfig.parsed['GOOGLE_API_KEY']}`;
